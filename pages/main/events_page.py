...
class EventsPage(Page):
    ...
    def get_first_card_pic(self):
        card = self.wait_until_and_get_elem_by_css(self.CARD_PIC)
        return card
    ...
    def redirect_to_first_inactive_category_tab(self):
        tab = self.wait_until_and_get_elem_by_css(self.TAB_INACTIVE_CLASS)
        tab.click()
    ...
    def get_active_tab_name(self):
        tab = self.wait_until_and_get_elem_by_css(self.TAB_ACTIVE_CLASS)
        return tab.text

    def get_notification_text(self):
        n = self.wait_until_and_get_elem_by_css(self.NOTIFICATION_TITLE_CLASS)
        return n.text

    def redirect_to_near_tab(self):
        tab = self.wait_until_and_get_elem_by_css(self.NEAR_TAB)
        tab.click()
