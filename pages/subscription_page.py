...
class SubscriptionPage(Page):
    ...
    def redirect_to_subscribed_to(self):
        tab = self.wait_visibility_until_and_get_elem_by_css(self.SUBSCRIBED_TO)
        tab.click()

    def redirect_to_subscribers(self):
        tab = self.wait_visibility_until_and_get_elem_by_css(self.SUBSCRIBERS)
        tab.click()

    def get_sub_name(self):
        text = self.wait_visibility_until_and_get_elem_by_css(self.SUB_NAME)
        return text.text
