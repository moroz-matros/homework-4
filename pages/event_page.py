...
class EventPage(Page):
    ...
    def get_vk_button(self):
        return self.wait_until_and_get_elem_by_css(self.VK_BUTTON)

    def get_copy_button(self):
        return self.wait_until_and_get_elem_by_css(self.COPY_BUTTON)

    def get_friends_list(self):
        return self.wait_until_and_get_elem_by_css(self.FRIENDS_LIST)

    def click_invite(self):
        button = self.wait_until_and_get_elem_by_css(self.INVITE_BUTTON)
        button.click()

    def get_status_text(self):
        status = self.wait_until_and_get_elem_by_css(self.STATUS_TEXT)
        return status.text
